...
// accountID identifies the concrete account/bot within that channel;
// chatID is the thread/session identifier within that account.
...
// MessageAccountID returns the account/bot id of the in-flight turn,
// or "" if not set.
