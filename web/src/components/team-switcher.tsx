...
// when available, falls back to the MyClaw logo for the platform header
...
//   activeAgentId unset   → show "MyClaw" (platform brand). The dropdown
...
export function AgentSwitcher({
  ...
  const headerLabel = active ? active.name || active.id : "MyClaw";
